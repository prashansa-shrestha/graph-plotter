...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(150, 32);
			...
			this->label5->Location = System::Drawing::Point(72, 28);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(346, 30);
			this->label5->TabIndex = 5;
			this->label5->Text = L"Roadside trip                                    XXX";
			// 
			// label4
			// 
			...
			this->label4->Size = System::Drawing::Size(346, 30);
			this->label4->TabIndex = 6;
			this->label4->Text = L"Roadside trip                                    XXX";
			// 
			// label7
			// 
			...
			this->label7->Location = System::Drawing::Point(72, 126);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(346, 30);
			this->label7->TabIndex = 8;
			this->label7->Text = L"Roadside trip                                    XXX";
			// 
			// label8
			// 
			...
			this->label8->Location = System::Drawing::Point(72, 169);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(346, 30);
			this->label8->TabIndex = 9;
			this->label8->Text = L"Roadside trip                                    XXX";
			this->label8->Click += gcnew System::EventHandler(this, &expensecategory::label8_Click);
			// 
			// label9
			// 
			...
			this->label9->Location = System::Drawing::Point(72, 217);
			this->label9->Name = L"label9";
			this->label9->Size = System::Drawing::Size(346, 30);
			this->label9->TabIndex = 10;
			this->label9->Text = L"Roadside trip                                    XXX";
			// 
			// panel1
			// 
			...
			this->panel1->Location = System::Drawing::Point(107, 168);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(490, 281);
			...
			this->ClientSize = System::Drawing::Size(721, 522);
			...
			this->Load += gcnew System::EventHandler(this, &expensecategory::expensecategory_Load);
...
#pragma endregion
	private: System::Void expensecategory_Load(System::Object^ sender, System::EventArgs^ e) {
	}
